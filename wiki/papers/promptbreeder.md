...
- **Related concepts:** [evolutionary-prompt-optimization](../concepts/evolutionary-prompt-optimization.md) (Promptbreeder is the canonical reference for the self-referential LLM-as-mutator subpattern), [llm-driven-evolution](../concepts/llm-driven-evolution.md) (Promptbreeder applies the LLM-as-mutator pattern to natural-language prompts and adds a self-referential layer on top), [novelty-and-quality-diversity](../concepts/novelty-and-quality-diversity.md) (the BERT-cosine diversity filter is a quality-diversity-flavoured response to LLM mode collapse).
