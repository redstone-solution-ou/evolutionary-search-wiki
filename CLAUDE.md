...
Thirteen paper leaves exist. Use these slugs in all cross-links:

```
alphaevolve   alphazero   eppo   evoprompt   grammatical-evolution   island-ga   lmx   mcc   model-merging   paired   plr   promptbreeder   shinkaevolve
```
