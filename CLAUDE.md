...
Eleven paper leaves exist. Use these slugs in all cross-links:

```
alphaevolve   alphazero   eppo   grammatical-evolution   island-ga   lmx   mcc   model-merging   paired   plr   shinkaevolve
```
